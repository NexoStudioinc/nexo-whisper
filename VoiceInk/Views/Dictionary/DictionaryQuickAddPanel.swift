...
struct DictionaryQuickAddView: View {
    ...
    private var vocabularyInput: some View {
        HStack(spacing: 11) {
            ...
            TextField("", text: $wordInput, prompt: Text("e.g. Maxi, Nexo Whisper").foregroundColor(.secondary))
        ...
        VStack(spacing: 8) {
            ...
            HStack(spacing: 10) {
                Text("With")
                    ...
                    .foregroundStyle(.secondary)
                    .frame(width: 56, alignment: .trailing)
                TextField("", text: $replacementInput, prompt: Text("e.g. soporte@nexostudio.xyz").foregroundColor(.secondary))
                    .textFieldStyle(.roundedBorder)
                    .font(.system(size: 14))
