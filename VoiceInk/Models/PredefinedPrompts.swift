...
enum PredefinedPrompts {
    ...
    private static let uuidByTitle: [String: UUID] = [
        ...
        // Nota: "Translate to English" y "Traducir a español" fueron removidos
        // a favor de la feature dinámica `targetTranslationLanguage` (un picker
        // en Settings → AI Enhancement que se aplica encima de cualquier prompt).
    ]
