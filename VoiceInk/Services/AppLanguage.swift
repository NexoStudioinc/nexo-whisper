...
enum AppText {
    ...
    private static let spanish: [String: String] = [
        ...
        "Control how VoiceInk handles your transcription data and audio recordings.": "Controlá cómo VoiceInk maneja tus transcripciones y grabaciones de audio.",
        ...
        "VoiceInk temporarily uses the clipboard to paste transcription. When enabled, it restores your previous clipboard content after the selected delay. When disabled, the pasted transcription stays on your clipboard.": "VoiceInk usa temporalmente el portapapeles para pegar la transcripción. Si está activo, restaura el contenido anterior después de la demora seleccionada. Si está apagado, la transcripción pegada queda en el portapapeles.",
